...
#load csv file
movies <- read.csv("/Users/archita/Desktop/info201/project-architasingh/MoviesOnStreamingPlatforms_updated.csv", header = TRUE)
...
#create pie chart
ggplot(age_group_amt.data, aes(x = "", y = prop, fill = Age_Group)) +
